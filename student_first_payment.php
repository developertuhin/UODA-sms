                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="float-right text-right">
                            ...
                            <strong>
                                <span id=""><?php echo $admission_fee; ?>TK</span> <br>
                                <span id=""><?php echo $monthly_fee; ?>TK</span> <br>
                                <span id=""><?php echo $total; ?>TK</span> <br>
                                <span id=""><?php echo $total; ?>TK</span> <br>
                            </strong>
