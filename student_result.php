    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <h1 style="text-align: center; padding: 50px; color:skyblue; font-weight: 800;"><span style="color: red;">***</span> Result Section Developing <span style="color: red;">***</span></h1>
                <!-- Main content -->
